  ...
  return (
    <div>
      <div style={{
        ...
        padding: desc ? '0 4px 4px' : '0 4px 10px',
        fontSize: 18, fontWeight: 800, color: '#1A202C',
        letterSpacing: '-0.3px',
      }}>
        <span>{title}</span>
        ...
        <div ref={cardRef}>
          ...
          <div style={{
            ...
            <div>
              ...
              {(isBusiness ? isFinite(realisticDays) : (isFinite(realisticDays) && realisticDays > 0)) ? (
                <>
                  <p style={{
          ...
          <div>
            <div style={{ position: 'relative' }}>
              <div style={{
                ...
                userSelect:    (isUnlocked || isCapturing) ? 'auto' : 'none',
                WebkitUserSelect: (isUnlocked || isCapturing) ? 'auto' : 'none',
                pointerEvents: (isUnlocked || isCapturing) ? 'auto' : 'none',
                transition:    'filter 0.3s ease',
              }}>
                <GradeRankPyramid
